...
public class AST_STMT_MODIFY_1 extends AST_STMT{
    ...
    public TYPE SemantMe() {
        ...
        if(t == null) {
            System.out.format(">> STMT_MODIFY_1: %s not in local scopes, then looking in father..\n", this.id_name1);
            t = isFuncInClassFields(this.id_name1);
            if (t == null) {
                System.out.format(">> STMT_MODIFY_1: %s not in local scopes & fathers, then looking in global..\n", this.id_name1);
